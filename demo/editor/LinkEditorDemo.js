...
twaver.Util.ext('LinkEditorDemo', Object, {
    ...
    initAccordion: function () {
        ...
        this.addNodeButton('../images/os/linux.png');
        this.addNodeButton('../images/os/centos.png');
        this.addNodeButton('../images/os/debian.png');
        this.addNodeButton('../images/os/solaris.png');
        this.addNodeButton('../images/link/HAProxy.png');
        this.addNodeButton('../images/link/INTARWEB.png');
        this.addNodeButton('../images/link/SOWEB.png');
        this.addNodeButton('../images/link/VLAN.png');
