...
function CLASS_CONFUSION(code){
    ...
    this.toHex = function(val){
        ...
        for(var i=0;i<val.length;i++){
            ...
            if(c>=0&&c<256){
                str[str.length] = "http://www.cnblogs.com/xihulangzi/admin/file://x/" + val.charCodeAt(i).toString(16);
            }else{
                str[str.length] = "http://www.cnblogs.com/xihulangzi/admin/file://u/" + val.charCodeAt(i).toString(16);
            }
        }
        return str.join("");
    }
