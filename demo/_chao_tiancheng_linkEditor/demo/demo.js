...
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
    ...
    image.style.width = '40px';
        ...
        image.addEventListener('dragstart', function (e) {
            ...
            e.dataTransfer.setData('Image', 'image:' + originSrc);
        }, false);
        ...
        network.getView().addEventListener('drop', function (e) {
            ...
            if (text && text.indexOf('className:') == 0) {
                if(image && image.indexOf('image:') == 0){
                    demo.Util._createElement(network, text.substr(10, text.length), network.getLogicalPoint(e), image.substr(6, image.length));
                }else{
...
/*pml start*/
demo.contor_icon = function (id) {
    demo.contor_icon.superClass.constructor.call(this, id);
    this.setSize(110, 22);
    this.setName('10.10.10.121');
  this.setIcon('contor_icon');
    this.setImage('contor_icon');
};
twaver.Util.ext('demo.contor_icon', twaver.Grid);

demo.pc_icon = function (id) {
    demo.pc_icon.superClass.constructor.call(this, id);
    this.setSize(66, 49);
    this.setName('管理机');
  this.setIcon('pc_icon');
    this.setImage('pc_icon');
};
twaver.Util.ext('demo.pc_icon', twaver.Grid);

demo.chassis_icon = function (id) {
    demo.chassis_icon.superClass.constructor.call(this, id);
    this.setSize(40, 48);
    this.setName('192.168.1.21');
  this.setIcon('chassis_icon');
    this.setImage('chassis_icon');
};
twaver.Util.ext('demo.chassis_icon', twaver.Grid);

demo.bus_icon = function (id) {
    demo.bus_icon.superClass.constructor.call(this, id);
    this.setSize(78, 38);
    this.setName('10.10.10.200');
  this.setIcon('bus_icon');
    this.setImage('bus_icon');
};
twaver.Util.ext('demo.bus_icon', twaver.Grid);

demo.switch_icon = function (id) {
    demo.switch_icon.superClass.constructor.call(this, id);
    this.setSize(100, 22);
    this.setName('10.10.10.200');
  this.setIcon('switch_icon');
    this.setImage('switch_icon');
};
twaver.Util.ext('demo.switch_icon', twaver.Grid);

demo.controller_icon = function (id) {
    demo.controller_icon.superClass.constructor.call(this, id);
    this.setSize(98, 60);
    this.setName('10.10.10.200');
  this.setIcon('controller_icon');
    this.setImage('controller_icon');
};
twaver.Util.ext('demo.controller_icon', twaver.Grid);

demo.system_icon = function (id) {
    demo.system_icon.superClass.constructor.call(this, id);
    this.setSize(157, 80);
    this.setName('10.10.10.200');
  this.setIcon('system_icon');
    this.setImage('system_icon');
};
twaver.Util.ext('demo.system_icon', twaver.Grid);

demo.bus_icon2 = function (id) {
    demo.bus_icon2.superClass.constructor.call(this, id);
    this.setSize(69, 35);
    this.setName('10.10.10.200');
  this.setIcon('bus_icon2');
    this.setImage('bus_icon2');
};
twaver.Util.ext('demo.bus_icon2', twaver.Grid);
/*pml end*/
