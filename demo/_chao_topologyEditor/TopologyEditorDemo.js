SHAPE_TYPE = ['rectangle','oval', 'roundrect', 'star', 'triangle', 'circle', 'hexagon', 'pentagon', 'diamond','trapezoidal'];
GRADIENT_TYPE = ['linear.east', 'linear.north', 'linear.northeast', 'linear.northwest', 'linear.south', 'linear.southeast', 'linear.southwest', 'linear.west', 'none', 'radial.center', 'radial.east', 'radial.north', 'radial.northeast', 'radial.northwest', 'radial.south', 'radial.southeast', 'radial.southwest', 'radial.west', 'spread.antidiagonal', 'spread.diagonal', 'spread.east', 'spread.horizontal', 'spread.north', 'spread.south', 'spread.vertical', 'spread.west'];
DIRECTION_TYPE = ['northwest', 'north', 'northeast', 'east', 'west', 'south', 'southwest', 'southeast'];
ATTACHMENT_DIRECTION_TYPE = ['aboveleft', 'aboveright', 'belowleft', 'belowright', 'leftabove', 'leftbelow', 'rightabove', 'rightbelow', 'above', 'below', 'left', 'right'];
POSITION_TYPE = ['topleft.topleft', 'top.top', 'topright.topright', 'right.right', 'left.left', 'bottom.bottom', 'bottomleft.bottomleft', 'bottomright.bottomright'];
NODE_ATTACHMENT_POSITION_TYPE = ['hotspot',
    'topleft.topleft',
    'topleft.topright',
    'top.top',
    'topright.topleft',
...
LINK_ATTACHMENT_POSITION_TYPE = ['hotspot',
    'from',
    'to',
    'topleft.topleft',
    'topleft.topright',
    ...
    'bottomright.bottomleft',
    'bottomright.bottomright'];
LINK_TYPE = ['arc', 'triangle', 'parallel', 'flexional', 'flexional.horizontal', 'flexional.vertical', 'orthogonal', , 'orthogonal.horizontal', 'orthogonal.vertical', 'orthogonal.H.V', 'orthogonal.V.H', 'extend.top', 'extend.left', 'extend.bottom', 'extend.right'];
LINK_LOOPED_TYPE = ['arc', 'rectangle'];
LINK_CORNER_TYPE = ['none', 'round', 'bevel'];
LAYOUT_TYPE = ['round', 'topbottom', 'bottomtop', 'symmetry', 'rightleft', 'leftright', 'hierarchic'];
BUS_STYLE_TYPE = ['nearby', 'north', 'south', 'west', 'east'];
SHAPELINK_TYPE = ['lineto', 'quadto', 'cubicto'];
BODY_TYPE = ['none', 'default', 'vector', 'default.vector', 'vector.default'];
SEGMENT_TYPE = ['moveto', 'lineto', 'quadto', 'cubicto'];
CAP_TYPE = ['butt', 'round', 'square'];
JOIN_TYPE = ['miter', 'round', 'bevel'];
ORIENTATION_TYPE = ['top', 'left', 'bottom', 'right'];
SELECT_TYPE = ['none', 'shadow', 'border'];
ARROW_SHAPE_TYPE = ['arrow.standard', 'arrow.delta', 'arrow.diamond', 'arrow.short', 'arrow.slant'];
...
twaver.Util.ext('TopologyEditorDemo', Object, {
    init: function () {
        ...
        rightSplit.setExpandable(true);
        rightSplit.setDividerWidth(20);
        ...
        this.registerTheImage("../images/svg/boy.svg");
        this.registerTheImage("../images/svg/girl.svg");
        this.initPopupMenu();
    },
    ...
    initTreeTable: function () {
        ...
        var tooltipColumn = this.createColumn(this.treeTable, 'ToolTip', 'toolTip', 'accessor', 'string', true);
        var enumInfoFunction = function(rowIndex){
            if(rowIndex === 0){
                return ["group1","node2","node3","group4","node5","node6","link7","link8"];
            }else{
                return ["node2","node3","group4","node5","node6","link7","link8"];
            }
        };
        tooltipColumn.setEnumInfo(enumInfoFunction);
    ...
    initPropertySheet: function (sheet) {
        ...
        var EnumInfoFunction = function(data){
            if(data instanceof twaver.Node){
                return NODE_ATTACHMENT_POSITION_TYPE;
            }else if (data instanceof twaver.Link){
                return LINK_ATTACHMENT_POSITION_TYPE;
            }
        };
        ...
        addLabelProperty('label.direction').setEnumInfo(ATTACHMENT_DIRECTION_TYPE);
        ...
        addLabelProperty('label.gradient').setEnumInfo(GRADIENT_TYPE);
        addLabelProperty('label.gradient.color');
        addLabelProperty('label.outline.width');
        addLabelProperty('label.outline.color');
        addLabelProperty('label.cap').setEnumInfo(CAP_TYPE);
        addLabelProperty('label.join').setEnumInfo(JOIN_TYPE);
        ...
        addSelectProperty('select.style').setEnumInfo(SELECT_TYPE);
        addSelectProperty('select.color');
        addSelectProperty('select.shape').setEnumInfo(SHAPE_TYPE);
        ...
        addSelectProperty('select.cap').setEnumInfo(CAP_TYPE);
        addSelectProperty('select.join').setEnumInfo(JOIN_TYPE);
        ...
        addAlarmProperty('alarm.direction').setEnumInfo(ATTACHMENT_DIRECTION_TYPE);
        ...
        addAlarmProperty('alarm.gradient').setEnumInfo(GRADIENT_TYPE);
        addAlarmProperty('alarm.gradient.color');
        addAlarmProperty('alarm.outline.width');
        addAlarmProperty('alarm.outline.color');
        addAlarmProperty('alarm.cap').setEnumInfo(CAP_TYPE);
        addAlarmProperty('alarm.join').setEnumInfo(JOIN_TYPE);
        ...
        addIconsProperty('icons.orientation').setEnumInfo(ORIENTATION_TYPE);
        ...
        addNodeProperty('body.type').setEnumInfo(BODY_TYPE);
        ...
        addVectorProperty('vector.shape').setEnumInfo(SHAPE_TYPE);
        ...
        addVectorProperty('vector.gradient').setEnumInfo(GRADIENT_TYPE);
        ...
        addVectorProperty('vector.cap').setEnumInfo(CAP_TYPE);
        addVectorProperty('vector.join').setEnumInfo(JOIN_TYPE);
        ...
        addLinkProperty('link.cap').setEnumInfo(CAP_TYPE);
        addLinkProperty('link.join').setEnumInfo(JOIN_TYPE);
        addLinkProperty('link.type').setEnumInfo(LINK_TYPE);
        ...
        addLinkProperty('link.looped.direction').setEnumInfo(DIRECTION_TYPE);
        addLinkProperty('link.looped.type').setEnumInfo(LINK_LOOPED_TYPE);
        addLinkProperty('link.from.position').setEnumInfo(POSITION_TYPE);
        addLinkProperty('link.from.xoffset');
        addLinkProperty('link.from.yoffset');
        addLinkProperty('link.from.at.edge');
        addLinkProperty('link.to.position').setEnumInfo(POSITION_TYPE);
        ...
        addLinkProperty('link.corner').setEnumInfo(LINK_CORNER_TYPE);
        ...
        addLinkHandleProperty('link.handler.direction').setEnumInfo(ATTACHMENT_DIRECTION_TYPE);
        ...
        addLinkHandleProperty('link.handler.gradient').setEnumInfo(GRADIENT_TYPE);
        ...
        addLinkHandleProperty('link.handler.cap').setEnumInfo(CAP_TYPE);
        addLinkHandleProperty('link.handler.join').setEnumInfo(JOIN_TYPE);
        ...
        addLinkArrowProperty('arrow.from.shape').setEnumInfo(ARROW_SHAPE_TYPE);
        ...
        addLinkArrowProperty('arrow.to.shape').setEnumInfo(ARROW_SHAPE_TYPE);
        ...
        addGroupProperty('group.shape').setEnumInfo(SHAPE_TYPE);
        ...
        addGroupProperty('group.gradient').setEnumInfo(GRADIENT_TYPE);
        ...
        addGroupProperty('group.cap').setEnumInfo(CAP_TYPE);
        addGroupProperty('group.join').setEnumInfo(JOIN_TYPE);
        ...
        addShapeLinkProperty('shapelink.type').setEnumInfo(SHAPELINK_TYPE);
        ...
        addBusProperty('bus.style').setEnumInfo(BUS_STYLE_TYPE);
    },
