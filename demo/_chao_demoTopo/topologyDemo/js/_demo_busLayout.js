...
twaver.Util.ext('BusLayoutDemo', Object, {
    ...
    registImages: function () {
        ...
        this.registerImage("images/net/portDownImage.png");
        this.registerImage("images/net/portUpImage.png");
        this.registerImage("images/net/rackImage.png");
    },
    ...
    initBox: function () {
        ...
        var node13 = new twaver.SubNetwork();
