...
//        network.adjustBounds({ x: 0, y: 0, width: 1200, height: 800 });
        ...
        var that = this;
        this.network.addInteractionListener(function(event){
            if(event.kind ==="enterSubNetwork"){
                that.tree.setDataBox(that.box2);
                console.log("~~~~~~~~~~~");
    ...
    initBox: function () {
        ...
        this.tree.setDataBox(this.box2);
