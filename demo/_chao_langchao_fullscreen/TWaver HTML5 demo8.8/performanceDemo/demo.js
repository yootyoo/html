...
//        this._createDemoNode('Attachment Demo', topologyNode, 'network/AttachmentDemo');
    ...
    createNetworkToolbar: function (network, interaction) {
        ...
        demo.Util.addButton(toolbar, 'Default', '../images/topo/toolbar/select.PNG', function () {
        ...
        demo.Util.addButton(toolbar, 'Magnify', '../images/topo/toolbar/magnify.PNG', function () {
            network.setMagnifyInteractions();
        });
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });

        demo.Util.addButton(toolbar, 'Zoom In', '../images/topo/toolbar/zoomIn.PNG', function () { network.zoomIn(); });
        demo.Util.addButton(toolbar, 'Zoom Out', '../images/topo/toolbar/zoomOut.PNG', function () { network.zoomOut(); });
        demo.Util.addButton(toolbar, 'Zoom Reset', '../images/topo/toolbar/zoomReset.PNG', function () { network.zoomReset(); });
        demo.Util.addButton(toolbar, 'Zoom Overview', '../images/topo/toolbar/zoomOverview.PNG', function () { network.zoomOverview(); });
        demo.Util.addInteractionComboBox(toolbar, network, interaction);
        demo.Util.addButton(toolbar, 'XML', '../images/topo/toolbar/save.PNG', function () {
        ...
        demo.Util.addButton(toolbar, 'Export Image', '../images/topo/toolbar/export.PNG', function () {
            var canvas;
        ...
        if (demo.Util.isFullScreenSupported()) {
            demo.Util.addButton(toolbar, 'Full screen', '../images/topo/toolbar/fullscreen.png', function () {
