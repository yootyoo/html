...
twaver.Util.ext('MatrixDemo', Object, {
    init: function () {
        ...
        this.addButton(toolbar, 'Create Group', 'group_icon', function () { self.createGroup(); });
        this.addButton(toolbar, 'Start', null, function () { self.initBox(true); });
        ...
        this.network.getSelectionModel().addSelectionChangeListener(function (e) {
            e.datas.forEach(function (element) {
                var color = self.createColor(this.fillColor, this.fillAlpha);
...
//        this.network.setRemoveElementUIOnInvisible(true);
    ...
    handlePropertyChange: function (e) {
        var name = this.getPropertyName(e);
    ...
    createGroup: function () {
        if (this.box.getSelectionModel().size() == 0) {
            ...
            group.setStyle('group.fill.color', this.randomColor());
            // group.setStyle('group.shape', 'oval');
            group.setStyle("group.shape","roundrect");
            group.setStyle("group.shape.roundrect.topLeftRadius",30);
            group.setStyle("group.shape.roundrect.topRightRadius",30);
            group.setStyle("group.shape.roundrect.bottomLeftRadius",30);
            group.setStyle("group.shape.roundrect.bottomRightRadius",30);
